...
DEFAULT_NOTES_DIR = paper_notes_dir()


def scan_notes(notes_dir: Path | None = None) -> dict:
...
def main():
    ...
    # Scan notes
    notes_dir = Path(args.notes_dir).expanduser() if args.notes_dir else DEFAULT_NOTES_DIR
    notes_index = scan_notes(notes_dir)
